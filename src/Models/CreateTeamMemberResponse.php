...
class CreateTeamMemberResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateTeamMemberResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreateTeamMemberResponse object.
     */
