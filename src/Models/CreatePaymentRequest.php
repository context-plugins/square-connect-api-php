 ...
 * [CreatePayment](https://developer.squareup.com/reference/square_2021-08-18/payments-api/create-
 * payment).
 */
class CreatePaymentRequest implements \JsonSerializable
{
     ...
     */
    public function __construct(Money $amountMoney, string $idempotencyKey, string $sourceId)
    {
    ...
    /**
     * Returns Customer Id.
     * The [Customer](https://developer.squareup.com/reference/square_2021-08-18/objects/Customer) ID of
