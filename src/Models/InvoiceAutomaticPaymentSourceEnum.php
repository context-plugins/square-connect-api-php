...
/**
 * Indicates the automatic payment method for an [invoice payment request](https://developer.squareup.
 * com/reference/square_2021-08-18/objects/InvoicePaymentRequest).
 */
class InvoiceAutomaticPaymentSourceEnum
{
    /**
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for InvoiceAutomaticPaymentSourceEnum.");
    }
}
