...
class SubmitEvidenceResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the SubmitEvidenceResponse object to a human-readable string representation.
     *
     * @return string The string representation of the SubmitEvidenceResponse object.
     */
