...
```php
use SquareConnectAPILib\Models\Builders\CreateCustomerCardRequestBuilder;
use SquareConnectAPILib\Models\Builders\AddressBuilder;

$createCustomerCardRequest = CreateCustomerCardRequestBuilder::init(
    'card_nonce4'
)
    ->billingAddress(
        AddressBuilder::init()
    ...
    ->cardholderName('cardholder_name0')
