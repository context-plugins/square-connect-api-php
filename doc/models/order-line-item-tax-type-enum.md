...
# Order Line Item Tax Type Enum

Indicates how the tax is applied to the associated line item or order.

## Enumeration

`OrderLineItemTaxTypeEnum`
...
```php
use SquareConnectAPILib\Models\OrderLineItemTaxTypeEnum;

$orderLineItemTaxType = OrderLineItemTaxTypeEnum::ADDITIVE;
```
