...
class CatalogPricingRule implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogPricingRule object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogPricingRule object.
     */
