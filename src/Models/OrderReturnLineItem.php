...
class OrderReturnLineItem implements \JsonSerializable
{
     ...
     * The [CatalogItemVariation](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/CatalogItemVariation) ID applied to this return line item.
     */
     ...
     * The [CatalogModifier](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/CatalogModifier)s applied to this line item.
     *
    ...
    /**
     * Converts the OrderReturnLineItem object to a human-readable string representation.
     *
     * @return string The string representation of the OrderReturnLineItem object.
     */
