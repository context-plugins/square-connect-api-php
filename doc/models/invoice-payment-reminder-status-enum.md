...
# Invoice Payment Reminder Status Enum

The status of a payment request reminder.

## Enumeration

`InvoicePaymentReminderStatusEnum`
...
```php
use SquareConnectAPILib\Models\InvoicePaymentReminderStatusEnum;

$invoicePaymentReminderStatus = InvoicePaymentReminderStatusEnum::NOT_APPLICABLE;
```
