...
class V1Employee implements \JsonSerializable
{
    ...
    /**
     * Returns Status.
     * Whether the employee is ACTIVE or INACTIVE. Inactive employees cannot sign in to Square Register.
     * Merchants update this field from the Square Dashboard.
     */
    ...
    /**
     * Converts the V1Employee object to a human-readable string representation.
     *
     * @return string The string representation of the V1Employee object.
     */
