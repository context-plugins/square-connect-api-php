...
# Team Member Assigned Locations Assignment Type Enum

Enumerates the possible assignment types that the team member can have.

## Enumeration

`TeamMemberAssignedLocationsAssignmentTypeEnum`
...
```php
use SquareConnectAPILib\Models\TeamMemberAssignedLocationsAssignmentTypeEnum;

$teamMemberAssignedLocationsAssignmentType = TeamMemberAssignedLocationsAssignmentTypeEnum::ALL_CURRENT_AND_FUTURE_LOCATIONS;
```
