...
namespace SquareConnectAPILib\Utils;
...
use SquareConnectAPILib\Http\HttpContext;
use SquareConnectAPILib\Http\HttpRequest;
use SquareConnectAPILib\Http\HttpResponse;
