...
class AccumulateLoyaltyPointsResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the AccumulateLoyaltyPointsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the AccumulateLoyaltyPointsResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'AccumulateLoyaltyPointsResponse',
            ['errors' => $this->errors, 'event' => $this->event]
        );
    }
