...
class CatalogQueryExact implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogQueryExact object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogQueryExact object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CatalogQueryExact',
            ['attributeName' => $this->attributeName, 'attributeValue' => $this->attributeValue]
        );
    }
