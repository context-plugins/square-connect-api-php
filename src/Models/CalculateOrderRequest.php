...
class CalculateOrderRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CalculateOrderRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CalculateOrderRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CalculateOrderRequest',
            ['order' => $this->order, 'proposedRewards' => $this->proposedRewards]
        );
    }
