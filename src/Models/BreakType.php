...
class BreakType implements \JsonSerializable
{
     ...
     */
    public function __construct(string $breakName, string $expectedDuration, bool $isPaid, string $locationId)
    {
    ...
    /**
     * Converts the BreakType object to a human-readable string representation.
     *
     * @return string The string representation of the BreakType object.
     */
