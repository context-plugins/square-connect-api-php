...
| `customerId` | `?string` | Optional | The ID of the customer. This is the customer profile ID that<br>you provide when creating a draft invoice.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255` | getCustomerId(): ?string | setCustomerId(?string customerId): void |
...
$invoiceRecipient = InvoiceRecipientBuilder::init()
    ->address(
        AddressBuilder::init()
