...
class V1PaymentItemization implements \JsonSerializable
{
    ...
    /**
     * Converts the V1PaymentItemization object to a human-readable string representation.
     *
     * @return string The string representation of the V1PaymentItemization object.
     */
