...
class CancelTerminalRefundResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CancelTerminalRefundResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CancelTerminalRefundResponse object.
     */
