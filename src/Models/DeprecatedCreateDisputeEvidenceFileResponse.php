...
class DeprecatedCreateDisputeEvidenceFileResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the DeprecatedCreateDisputeEvidenceFileResponse object to a human-readable string
     * representation.
     *
     * @return string The string representation of the DeprecatedCreateDisputeEvidenceFileResponse object.
     */
