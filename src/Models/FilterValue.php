...
class FilterValue implements \JsonSerializable
{
    ...
    /**
     * Converts the FilterValue object to a human-readable string representation.
     *
     * @return string The string representation of the FilterValue object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'FilterValue',
            ['all' => $this->all, 'any' => $this->any, 'none' => $this->none]
        );
    }
