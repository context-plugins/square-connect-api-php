...
# Catalog Discount Type Enum

How to apply a CatalogDiscount to a CatalogItem.

## Enumeration

`CatalogDiscountTypeEnum`
...
```php
use SquareConnectAPILib\Models\CatalogDiscountTypeEnum;

$catalogDiscountType = CatalogDiscountTypeEnum::VARIABLE_PERCENTAGE;
```
