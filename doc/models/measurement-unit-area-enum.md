...
# Measurement Unit Area Enum

Unit of area used to measure a quantity.

## Enumeration

`MeasurementUnitAreaEnum`
...
```php
use SquareConnectAPILib\Models\MeasurementUnitAreaEnum;

$measurementUnitArea = MeasurementUnitAreaEnum::IMPERIAL_SQUARE_MILE;
```
