...
```php
use SquareConnectAPILib\Models\Builders\CompletePaymentResponseBuilder;
...
$completePaymentResponse = CompletePaymentResponseBuilder::init()
    ->errors(
        [
            ErrorBuilder::init(
                'category8',
    ...
    ->payment(
        PaymentBuilder::init()
            ...
            ->createdAt('2019-07-10T13:39:55.317Z')
            ...
            ->updatedAt('2019-07-10T13:40:05.982Z')
            ->versionToken('7knzZI16u3QBh2xXD7FH4GFwESqgam7Z9w2Ya0aSD9i6o')
            ->build()
    )
    ->build();
```
