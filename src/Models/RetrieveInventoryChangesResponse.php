...
class RetrieveInventoryChangesResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveInventoryChangesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveInventoryChangesResponse object.
     */
