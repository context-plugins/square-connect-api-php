...
class LoyaltyEventRedeemReward implements \JsonSerializable
{
    ...
    /**
     * Returns Order Id.
     * The ID of the [order](https://developer.squareup.com/reference/square_2021-08-18/objects/Order) that
     * redeemed the reward.
    ...
    /**
     * Returns Reward Id.
     * The ID of the redeemed [loyalty reward](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/LoyaltyReward).
    ...
    /**
     * Converts the LoyaltyEventRedeemReward object to a human-readable string representation.
     *
     * @return string The string representation of the LoyaltyEventRedeemReward object.
     */
