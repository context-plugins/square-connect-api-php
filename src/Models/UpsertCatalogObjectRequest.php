...
class UpsertCatalogObjectRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the UpsertCatalogObjectRequest object to a human-readable string representation.
     *
     * @return string The string representation of the UpsertCatalogObjectRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'UpsertCatalogObjectRequest',
            ['idempotencyKey' => $this->idempotencyKey, 'object' => $this->object]
        );
    }
