...
class ProcessingFee implements \JsonSerializable
{
    ...
    /**
     * Converts the ProcessingFee object to a human-readable string representation.
     *
     * @return string The string representation of the ProcessingFee object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'ProcessingFee',
            ['amountMoney' => $this->amountMoney, 'effectiveAt' => $this->effectiveAt, 'type' => $this->type]
        );
    }
