...
```php
use SquareConnectAPILib\Models\Builders\CatalogCustomAttributeDefinitionStringConfigBuilder;

$catalogCustomAttributeDefinitionStringConfig = CatalogCustomAttributeDefinitionStringConfigBuilder::init()
