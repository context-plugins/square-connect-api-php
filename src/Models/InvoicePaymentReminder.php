...
class InvoicePaymentReminder implements \JsonSerializable
{
    ...
    /**
     * Converts the InvoicePaymentReminder object to a human-readable string representation.
     *
     * @return string The string representation of the InvoicePaymentReminder object.
     */
