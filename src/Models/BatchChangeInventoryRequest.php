...
class BatchChangeInventoryRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the BatchChangeInventoryRequest object to a human-readable string representation.
     *
     * @return string The string representation of the BatchChangeInventoryRequest object.
     */
