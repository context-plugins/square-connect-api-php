...
class TenderCashDetails implements \JsonSerializable
{
    ...
    /**
     * Converts the TenderCashDetails object to a human-readable string representation.
     *
     * @return string The string representation of the TenderCashDetails object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'TenderCashDetails',
            ['buyerTenderedMoney' => $this->buyerTenderedMoney, 'changeBackMoney' => $this->changeBackMoney]
        );
    }
