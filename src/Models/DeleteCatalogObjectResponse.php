...
class DeleteCatalogObjectResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the DeleteCatalogObjectResponse object to a human-readable string representation.
     *
     * @return string The string representation of the DeleteCatalogObjectResponse object.
     */
