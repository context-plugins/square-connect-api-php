...
class BatchRetrieveInventoryCountsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the BatchRetrieveInventoryCountsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the BatchRetrieveInventoryCountsRequest object.
     */
