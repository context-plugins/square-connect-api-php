...
use SquareConnectAPILib\Server;
use SquareConnectAPILib\Models\OAuthToken;
...
class Oauth2Manager extends CoreAuth implements Oauth2Credentials
{
    ...
    {
        return (new RequestBuilder(RequestMethod::GET, '/oauth2/authorize'))
            ->server(Server::DEFAULT_)
            ->parameters(
    ...
    public function refreshToken(?array $additionalParams = null): OAuthToken
    {
        ...
        $oAuthToken = $this->oAuthApi->refreshTokenOauth2(
            $this->buildBasicHeader(),
