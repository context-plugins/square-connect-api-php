...
```php
use SquareConnectAPILib\Models\Builders\GiftCardActivityUnlinkedActivityRefundBuilder;
use SquareConnectAPILib\Models\Builders\MoneyBuilder;

$giftCardActivityUnlinkedActivityRefund = GiftCardActivityUnlinkedActivityRefundBuilder::init(
    MoneyBuilder::init()
        ->amount(186)
        ->currency('currency8')
        ->build()
