...
# Order Line Item Discount Scope Enum

Indicates whether this is a line-item or order-level discount.

## Enumeration

`OrderLineItemDiscountScopeEnum`
...
```php
use SquareConnectAPILib\Models\OrderLineItemDiscountScopeEnum;

$orderLineItemDiscountScope = OrderLineItemDiscountScopeEnum::LINE_ITEM;
```
