...
class CatalogMeasurementUnit implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogMeasurementUnit object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogMeasurementUnit object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CatalogMeasurementUnit',
            ['measurementUnit' => $this->measurementUnit, 'precision' => $this->precision]
        );
    }
