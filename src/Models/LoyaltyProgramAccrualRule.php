...
class LoyaltyProgramAccrualRule implements \JsonSerializable
{
     ...
     * of the [catalog object](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/CatalogObject) that buyers can purchase to earn points.
     ...
     *
     * You can use the [BatchRetrieveCatalogObjects](https://developer.squareup.com/reference/square_2021-
     * 08-18/catalog-api/batch-retrieve-catalog-objects)
    ...
    /**
     * Converts the LoyaltyProgramAccrualRule object to a human-readable string representation.
     *
     * @return string The string representation of the LoyaltyProgramAccrualRule object.
     */
