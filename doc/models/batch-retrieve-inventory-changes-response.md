...
```php
use SquareConnectAPILib\Models\Builders\BatchRetrieveInventoryChangesResponseBuilder;
...
$batchRetrieveInventoryChangesResponse = BatchRetrieveInventoryChangesResponseBuilder::init()
    ->changes(
        [
