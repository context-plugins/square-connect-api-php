...
```php
use SquareConnectAPILib\Models\Builders\RetrieveInventoryCountResponseBuilder;
use SquareConnectAPILib\Models\Builders\InventoryCountBuilder;

$retrieveInventoryCountResponse = RetrieveInventoryCountResponseBuilder::init()
    ->counts(
        [
