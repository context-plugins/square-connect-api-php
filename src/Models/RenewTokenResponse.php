...
class RenewTokenResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RenewTokenResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RenewTokenResponse object.
     */
