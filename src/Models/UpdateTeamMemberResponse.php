...
class UpdateTeamMemberResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the UpdateTeamMemberResponse object to a human-readable string representation.
     *
     * @return string The string representation of the UpdateTeamMemberResponse object.
     */
