...
| `cardId` | `?string` | Optional | The ID of the [customer](https://developer.squareup.com/reference/square_2021-08-18/objects/Customer) [card](https://developer.squareup.com/reference/square_2021-08-18/objects/Card)<br>that is charged for the subscription. | getCardId(): ?string | setCardId(?string cardId): void |
...
| `customerId` | `?string` | Optional | The ID of the associated [customer](https://developer.squareup.com/reference/square_2021-08-18/objects/Customer) profile. | getCustomerId(): ?string | setCustomerId(?string customerId): void |
| `id` | `?string` | Optional | The Square-assigned ID of the subscription.<br><br>**Constraints**: *Maximum Length*: `255` | getId(): ?string | setId(?string id): void |
| `invoiceIds` | `?(string[])` | Optional | The IDs of the [invoices](https://developer.squareup.com/reference/square_2021-08-18/objects/Invoice) created for the<br>subscription, listed in order when the invoices were created<br>(oldest invoices appear first). | getInvoiceIds(): ?array | setInvoiceIds(?array invoiceIds): void |
...
| `planId` | `?string` | Optional | The ID of the associated [subscription plan](https://developer.squareup.com/reference/square_2021-08-18/objects/CatalogSubscriptionPlan). | getPlanId(): ?string | setPlanId(?string planId): void |
...
| `status` | `?string` | Optional | The current status of the subscription. | getStatus(): ?string | setStatus(?string status): void |
