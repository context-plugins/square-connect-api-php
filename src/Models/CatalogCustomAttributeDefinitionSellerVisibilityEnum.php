 ...
 */
class CatalogCustomAttributeDefinitionSellerVisibilityEnum
{
    /**
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for CatalogCustomAttributeDefinitionSellerVisibilityEnum.");
    }
}
