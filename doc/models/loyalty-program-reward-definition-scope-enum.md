...
# Loyalty Program Reward Definition Scope Enum
...
`LoyaltyProgramRewardDefinitionScopeEnum`
...
```php
use SquareConnectAPILib\Models\LoyaltyProgramRewardDefinitionScopeEnum;

$loyaltyProgramRewardDefinitionScope = LoyaltyProgramRewardDefinitionScopeEnum::CATEGORY;
```
