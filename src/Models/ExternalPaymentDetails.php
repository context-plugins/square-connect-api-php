...
class ExternalPaymentDetails implements \JsonSerializable
{
    ...
    /**
     * Converts the ExternalPaymentDetails object to a human-readable string representation.
     *
     * @return string The string representation of the ExternalPaymentDetails object.
     */
