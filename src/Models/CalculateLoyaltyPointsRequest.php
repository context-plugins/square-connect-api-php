...
class CalculateLoyaltyPointsRequest implements \JsonSerializable
{
    ...
    /**
     * Returns Order Id.
     * The [order](https://developer.squareup.com/reference/square_2021-08-18/objects/Order) ID for which
    ...
    /**
     * Converts the CalculateLoyaltyPointsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CalculateLoyaltyPointsRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CalculateLoyaltyPointsRequest',
            ['orderId' => $this->orderId, 'transactionAmountMoney' => $this->transactionAmountMoney]
        );
    }
