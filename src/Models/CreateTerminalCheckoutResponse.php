...
class CreateTerminalCheckoutResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateTerminalCheckoutResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreateTerminalCheckoutResponse object.
     */
