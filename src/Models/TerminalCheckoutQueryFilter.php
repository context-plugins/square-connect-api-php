...
class TerminalCheckoutQueryFilter implements \JsonSerializable
{
    ...
    /**
     * Converts the TerminalCheckoutQueryFilter object to a human-readable string representation.
     *
     * @return string The string representation of the TerminalCheckoutQueryFilter object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'TerminalCheckoutQueryFilter',
            ['createdAt' => $this->createdAt, 'deviceId' => $this->deviceId, 'status' => $this->status]
        );
    }
