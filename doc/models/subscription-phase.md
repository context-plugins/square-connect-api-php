...
|  --- | --- | --- | --- | --- | --- |
| `cadence` | `string` | Required | The billing cadence of the phase. For example, weekly or monthly. This field cannot be changed after a `SubscriptionPhase` is created. | getCadence(): string | setCadence(string cadence): void |
...
$subscriptionPhase = SubscriptionPhaseBuilder::init(
    'cadence2',
    MoneyBuilder::init()
        ->amount(66)
        ->currency('currency2')
