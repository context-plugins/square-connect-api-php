...
|  --- | --- | --- | --- | --- | --- |
| `cardBrand` | `?string` | Optional | The brand of credit card provided. | getCardBrand(): ?string | setCardBrand(?string cardBrand): void |
...
| `entryMethod` | `?string` | Optional | The tender's unique ID. | getEntryMethod(): ?string | setEntryMethod(?string entryMethod): void |
...
| `type` | `?string` | Optional | The type of tender. | getType(): ?string | setType(?string type): void |

## Example

```php
use SquareConnectAPILib\Models\Builders\V1TenderBuilder;
use SquareConnectAPILib\Models\Builders\V1MoneyBuilder;

$v1Tender = V1TenderBuilder::init()
