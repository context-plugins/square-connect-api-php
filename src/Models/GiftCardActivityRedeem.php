...
class GiftCardActivityRedeem implements \JsonSerializable
{
    ...
    /**
     * Converts the GiftCardActivityRedeem object to a human-readable string representation.
     *
     * @return string The string representation of the GiftCardActivityRedeem object.
     */
