...
| `id` | `?string` | Optional | The Square-assigned ID of the mapping.<br><br>**Constraints**: *Maximum Length*: `36` | getId(): ?string | setId(?string id): void |
...
$loyaltyAccountMapping = LoyaltyAccountMappingBuilder::init()
