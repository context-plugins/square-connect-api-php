...
class UpdateWageSettingResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the UpdateWageSettingResponse object to a human-readable string representation.
     *
     * @return string The string representation of the UpdateWageSettingResponse object.
     */
