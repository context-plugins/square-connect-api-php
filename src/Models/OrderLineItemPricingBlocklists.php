...
class OrderLineItemPricingBlocklists implements \JsonSerializable
{
    ...
    /**
     * Converts the OrderLineItemPricingBlocklists object to a human-readable string representation.
     *
     * @return string The string representation of the OrderLineItemPricingBlocklists object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'OrderLineItemPricingBlocklists',
            ['blockedDiscounts' => $this->blockedDiscounts, 'blockedTaxes' => $this->blockedTaxes]
        );
    }
