...
# Checkout Options Payment Type Enum

## Enumeration

`CheckoutOptionsPaymentTypeEnum`
...
```php
use SquareConnectAPILib\Models\CheckoutOptionsPaymentTypeEnum;

$checkoutOptionsPaymentType = CheckoutOptionsPaymentTypeEnum::FELICA_ID;
```
