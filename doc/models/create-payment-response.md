...
```php
use SquareConnectAPILib\Models\Builders\CreatePaymentResponseBuilder;
...
$createPaymentResponse = CreatePaymentResponseBuilder::init()
    ->errors(
        [
            ErrorBuilder::init(
                'category8',
    ...
    ->payment(
        PaymentBuilder::init()
            ...
            ->versionToken('H8Vnk5Z11SKcueuRti79jGpszSEsSVdhKRrSKCOzILG6o')
            ->build()
    )
    ->build();
```
