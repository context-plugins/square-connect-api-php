...
class CreateLoyaltyAccountResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateLoyaltyAccountResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreateLoyaltyAccountResponse object.
     */
