...
```php
use SquareConnectAPILib\Models\Builders\CreateDisputeEvidenceTextRequestBuilder;

$createDisputeEvidenceTextRequest = CreateDisputeEvidenceTextRequestBuilder::init(
    'evidence_text6',
    'idempotency_key8'
)
