...
class OrderFulfillmentShipmentDetails implements \JsonSerializable
{
    ...
    /**
     * Converts the OrderFulfillmentShipmentDetails object to a human-readable string representation.
     *
     * @return string The string representation of the OrderFulfillmentShipmentDetails object.
     */
