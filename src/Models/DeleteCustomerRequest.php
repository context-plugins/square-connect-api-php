...
class DeleteCustomerRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the DeleteCustomerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeleteCustomerRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('DeleteCustomerRequest', ['version' => $this->version]);
    }
