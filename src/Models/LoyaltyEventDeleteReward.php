...
class LoyaltyEventDeleteReward implements \JsonSerializable
{
    ...
    /**
     * Returns Reward Id.
     * The ID of the deleted [loyalty reward](https://developer.squareup.com/reference/square_2021-08-
    ...
    /**
     * Converts the LoyaltyEventDeleteReward object to a human-readable string representation.
     *
     * @return string The string representation of the LoyaltyEventDeleteReward object.
     */
