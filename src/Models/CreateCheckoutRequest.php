...
class CreateCheckoutRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateCheckoutRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CreateCheckoutRequest object.
     */
