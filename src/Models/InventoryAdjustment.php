...
class InventoryAdjustment implements \JsonSerializable
{
     ...
     * 18/enums/InventoryState) of the related quantity
    ...
    /**
     * Converts the InventoryAdjustment object to a human-readable string representation.
     *
     * @return string The string representation of the InventoryAdjustment object.
     */
