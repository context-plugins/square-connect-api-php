...
# Measurement Unit Length Enum

The unit of length used to measure a quantity.

## Enumeration

`MeasurementUnitLengthEnum`
...
```php
use SquareConnectAPILib\Models\MeasurementUnitLengthEnum;

$measurementUnitLength = MeasurementUnitLengthEnum::METRIC_MILLIMETER;
```
