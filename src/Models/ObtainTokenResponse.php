...
class ObtainTokenResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ObtainTokenResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ObtainTokenResponse object.
     */
