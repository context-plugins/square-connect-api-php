...
class UnlinkCustomerFromGiftCardResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the UnlinkCustomerFromGiftCardResponse object to a human-readable string representation.
     *
     * @return string The string representation of the UnlinkCustomerFromGiftCardResponse object.
     */
