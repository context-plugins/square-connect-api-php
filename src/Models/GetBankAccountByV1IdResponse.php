...
class GetBankAccountByV1IdResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the GetBankAccountByV1IdResponse object to a human-readable string representation.
     *
     * @return string The string representation of the GetBankAccountByV1IdResponse object.
     */
