...
class RetrieveCatalogObjectResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveCatalogObjectResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveCatalogObjectResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'RetrieveCatalogObjectResponse',
            ['errors' => $this->errors, 'object' => $this->object, 'relatedObjects' => $this->relatedObjects]
        );
    }
