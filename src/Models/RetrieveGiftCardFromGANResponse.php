...
class RetrieveGiftCardFromGANResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveGiftCardFromGANResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveGiftCardFromGANResponse object.
     */
