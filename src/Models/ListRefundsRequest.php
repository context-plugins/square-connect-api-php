...
class ListRefundsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ListRefundsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ListRefundsRequest object.
     */
