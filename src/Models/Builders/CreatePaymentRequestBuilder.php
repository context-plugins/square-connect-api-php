...
class CreatePaymentRequestBuilder
{
     ...
     */
    public static function init(Money $amountMoney, string $idempotencyKey, string $sourceId): self
    {
        return new self(new CreatePaymentRequest($amountMoney, $idempotencyKey, $sourceId));
    }
