...
# Measurement Unit Unit Type Enum

Describes the type of this unit and indicates which field contains the unit information. This is an ‘open’ enum.

## Enumeration

`MeasurementUnitUnitTypeEnum`
...
```php
use SquareConnectAPILib\Models\MeasurementUnitUnitTypeEnum;

$measurementUnitUnitType = MeasurementUnitUnitTypeEnum::TYPE_CUSTOM;
```
