...
/**
 * A [CatalogModifier](https://developer.squareup.com/reference/square_2021-08-
 * 18/objects/CatalogModifier).
 */
class OrderLineItemModifier implements \JsonSerializable
{
     ...
     * The catalog object ID referencing [CatalogModifier](https://developer.squareup.
     * com/reference/square_2021-08-18/objects/CatalogModifier).
     */
    ...
    /**
     * Converts the OrderLineItemModifier object to a human-readable string representation.
     *
     * @return string The string representation of the OrderLineItemModifier object.
     */
