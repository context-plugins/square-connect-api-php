...
namespace SquareConnectAPILib\Exceptions;
...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \SquareConnectAPILib\Http\HttpRequest $request
     * @param \SquareConnectAPILib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \SquareConnectAPILib\Http\HttpRequest $request,
        \SquareConnectAPILib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \SquareConnectAPILib\Models\OAuthProviderErrorEnum::checkValue
     */
