...
class CreateBreakTypeResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateBreakTypeResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreateBreakTypeResponse object.
     */
