...
class CatalogQueryRange implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogQueryRange object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogQueryRange object.
     */
