...
# Invoice Automatic Payment Source Enum
...
`InvoiceAutomaticPaymentSourceEnum`
...
```php
use SquareConnectAPILib\Models\InvoiceAutomaticPaymentSourceEnum;

$invoiceAutomaticPaymentSource = InvoiceAutomaticPaymentSourceEnum::BANK_ON_FILE;
```
