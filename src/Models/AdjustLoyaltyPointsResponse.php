...
class AdjustLoyaltyPointsResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the AdjustLoyaltyPointsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the AdjustLoyaltyPointsResponse object.
     */
