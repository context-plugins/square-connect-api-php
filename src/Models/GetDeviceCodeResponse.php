...
class GetDeviceCodeResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the GetDeviceCodeResponse object to a human-readable string representation.
     *
     * @return string The string representation of the GetDeviceCodeResponse object.
     */
