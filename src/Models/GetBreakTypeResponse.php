...
class GetBreakTypeResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the GetBreakTypeResponse object to a human-readable string representation.
     *
     * @return string The string representation of the GetBreakTypeResponse object.
     */
