...
class RetrieveBookingResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveBookingResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveBookingResponse object.
     */
