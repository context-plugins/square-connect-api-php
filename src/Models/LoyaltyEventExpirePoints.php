...
class LoyaltyEventExpirePoints implements \JsonSerializable
{
    ...
    /**
     * Converts the LoyaltyEventExpirePoints object to a human-readable string representation.
     *
     * @return string The string representation of the LoyaltyEventExpirePoints object.
     */
