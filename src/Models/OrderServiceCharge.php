...
class OrderServiceCharge implements \JsonSerializable
{
     ...
     * The catalog object ID referencing the service charge [CatalogObject](https://developer.squareup.
     * com/reference/square_2021-08-18/objects/CatalogObject).
     */
    ...
    /**
     * Converts the OrderServiceCharge object to a human-readable string representation.
     *
     * @return string The string representation of the OrderServiceCharge object.
     */
