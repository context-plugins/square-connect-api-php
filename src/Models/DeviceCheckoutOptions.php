...
class DeviceCheckoutOptions implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceCheckoutOptions object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceCheckoutOptions object.
     */
