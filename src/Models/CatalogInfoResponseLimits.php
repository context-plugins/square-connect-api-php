...
class CatalogInfoResponseLimits implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogInfoResponseLimits object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogInfoResponseLimits object.
     */
