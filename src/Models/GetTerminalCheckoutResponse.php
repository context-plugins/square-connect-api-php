...
class GetTerminalCheckoutResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the GetTerminalCheckoutResponse object to a human-readable string representation.
     *
     * @return string The string representation of the GetTerminalCheckoutResponse object.
     */
