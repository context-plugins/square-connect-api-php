...
class PayOrderRequest implements \JsonSerializable
{
    ...
    /**
     * Returns Payment Ids.
     * The IDs of the [payments](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/Payment) to collect.
    ...
    /**
     * Converts the PayOrderRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PayOrderRequest object.
     */
