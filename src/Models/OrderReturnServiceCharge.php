...
class OrderReturnServiceCharge implements \JsonSerializable
{
     ...
     * The catalog object ID of the associated [OrderServiceCharge](https://developer.squareup.
     * com/reference/square_2021-08-18/objects/OrderServiceCharge).
     */
    ...
    /**
     * Converts the OrderReturnServiceCharge object to a human-readable string representation.
     *
     * @return string The string representation of the OrderReturnServiceCharge object.
     */
