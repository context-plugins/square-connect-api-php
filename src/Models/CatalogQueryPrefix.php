...
class CatalogQueryPrefix implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogQueryPrefix object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogQueryPrefix object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CatalogQueryPrefix',
            ['attributeName' => $this->attributeName, 'attributePrefix' => $this->attributePrefix]
        );
    }
