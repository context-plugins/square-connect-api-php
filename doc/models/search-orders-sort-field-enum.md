...
# Search Orders Sort Field Enum

Specifies which timestamp to use to sort `SearchOrder` results.

## Enumeration

`SearchOrdersSortFieldEnum`
...
```php
use SquareConnectAPILib\Models\SearchOrdersSortFieldEnum;

$searchOrdersSortField = SearchOrdersSortFieldEnum::UPDATED_AT;
```
