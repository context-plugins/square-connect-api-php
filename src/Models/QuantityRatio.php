...
class QuantityRatio implements \JsonSerializable
{
    ...
    /**
     * Converts the QuantityRatio object to a human-readable string representation.
     *
     * @return string The string representation of the QuantityRatio object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'QuantityRatio',
            ['quantity' => $this->quantity, 'quantityDenominator' => $this->quantityDenominator]
        );
    }
