...
class CardPaymentDetails implements \JsonSerializable
{
    ...
    /**
     * Converts the CardPaymentDetails object to a human-readable string representation.
     *
     * @return string The string representation of the CardPaymentDetails object.
     */
