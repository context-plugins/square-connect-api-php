...
```php
use SquareConnectAPILib\Models\Builders\BatchDeleteCatalogObjectsResponseBuilder;
use SquareConnectAPILib\Models\Builders\ErrorBuilder;

$batchDeleteCatalogObjectsResponse = BatchDeleteCatalogObjectsResponseBuilder::init()
