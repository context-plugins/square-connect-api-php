...
class V1PaymentModifier implements \JsonSerializable
{
    ...
    /**
     * Converts the V1PaymentModifier object to a human-readable string representation.
     *
     * @return string The string representation of the V1PaymentModifier object.
     */
