...
# Measurement Unit Volume Enum

The unit of volume used to measure a quantity.

## Enumeration

`MeasurementUnitVolumeEnum`
...
```php
use SquareConnectAPILib\Models\MeasurementUnitVolumeEnum;

$measurementUnitVolume = MeasurementUnitVolumeEnum::METRIC_LITER;
```
