...
```php
use SquareConnectAPILib\Models\Builders\RetrieveDisputeEvidenceResponseBuilder;
...
$retrieveDisputeEvidenceResponse = RetrieveDisputeEvidenceResponseBuilder::init()
    ->errors(
        [
            ErrorBuilder::init(
                'category8',
