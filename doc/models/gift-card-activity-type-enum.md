...
# Gift Card Activity Type Enum

## Enumeration

`GiftCardActivityTypeEnum`
...
```php
use SquareConnectAPILib\Models\GiftCardActivityTypeEnum;

$giftCardActivityType = GiftCardActivityTypeEnum::IMPORT;
```
