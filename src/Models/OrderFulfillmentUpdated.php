...
class OrderFulfillmentUpdated implements \JsonSerializable
{
    ...
    /**
     * Converts the OrderFulfillmentUpdated object to a human-readable string representation.
     *
     * @return string The string representation of the OrderFulfillmentUpdated object.
     */
