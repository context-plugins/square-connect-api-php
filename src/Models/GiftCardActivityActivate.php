...
class GiftCardActivityActivate implements \JsonSerializable
{
    ...
    /**
     * Converts the GiftCardActivityActivate object to a human-readable string representation.
     *
     * @return string The string representation of the GiftCardActivityActivate object.
     */
