...
/**
 * Indicates how Square delivers the [invoice](https://developer.squareup.com/reference/square_2021-08-
 * 18/objects/Invoice) to the customer.
 */
class InvoiceDeliveryMethodEnum
{
    /**
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for InvoiceDeliveryMethodEnum.");
    }
}
