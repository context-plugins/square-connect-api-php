...
```php
use SquareConnectAPILib\Models\Builders\ChargeRequestBuilder;
...
$chargeRequest = ChargeRequestBuilder::init(
    MoneyBuilder::init()
        ->amount(186)
        ->currency('currency8')
        ->build(),
    ...
    ->buyerEmailAddress('buyer_email_address6')
    ->cardNonce('card_nonce8')
