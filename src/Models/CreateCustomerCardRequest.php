...
class CreateCustomerCardRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateCustomerCardRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CreateCustomerCardRequest object.
     */
