...
class TaxIds implements \JsonSerializable
{
    ...
    /**
     * Converts the TaxIds object to a human-readable string representation.
     *
     * @return string The string representation of the TaxIds object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'TaxIds',
            ['euVat' => $this->euVat, 'frNaf' => $this->frNaf, 'frSiret' => $this->frSiret]
        );
    }
