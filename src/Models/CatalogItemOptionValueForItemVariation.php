...
class CatalogItemOptionValueForItemVariation implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogItemOptionValueForItemVariation object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogItemOptionValueForItemVariation object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CatalogItemOptionValueForItemVariation',
            ['itemOptionId' => $this->itemOptionId, 'itemOptionValueId' => $this->itemOptionValueId]
        );
    }
