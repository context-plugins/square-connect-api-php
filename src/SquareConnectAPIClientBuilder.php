...
class SquareConnectAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function oauth2ClientSecretCredentials(Oauth2ClientSecretCredentialsBuilder $oauth2ClientSecret): self
    {
        $this->config = array_merge($this->config, $oauth2ClientSecret->getConfiguration());
        return $this;
    }
    ...
    public function build(): SquareConnectAPIClient
    {
        return new SquareConnectAPIClient($this->config);
    }
}
