...
class SearchTerminalCheckoutsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the SearchTerminalCheckoutsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the SearchTerminalCheckoutsRequest object.
     */
