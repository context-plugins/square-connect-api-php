...
```php
use SquareConnectAPILib\Models\Builders\CreateDisputeEvidenceTextResponseBuilder;
...
$createDisputeEvidenceTextResponse = CreateDisputeEvidenceTextResponseBuilder::init()
    ->errors(
        [
            ErrorBuilder::init(
                'category8',
