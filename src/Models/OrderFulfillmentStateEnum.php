 ...
 */
class OrderFulfillmentStateEnum
{
    /**
    ...
    private const _ALL_VALUES =
        [self::PROPOSED, self::RESERVED, self::PREPARED, self::COMPLETED, self::CANCELED, self::FAILED];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for OrderFulfillmentStateEnum.");
    }
}
