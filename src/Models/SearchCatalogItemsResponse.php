...
/**
 * Defines the response body returned from the [SearchCatalogItems](https://developer.squareup.
...
class SearchCatalogItemsResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the SearchCatalogItemsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the SearchCatalogItemsResponse object.
     */
