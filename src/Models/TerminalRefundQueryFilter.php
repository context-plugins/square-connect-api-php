...
class TerminalRefundQueryFilter implements \JsonSerializable
{
    ...
    /**
     * Converts the TerminalRefundQueryFilter object to a human-readable string representation.
     *
     * @return string The string representation of the TerminalRefundQueryFilter object.
     */
