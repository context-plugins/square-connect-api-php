...
class RetrieveSnippetResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveSnippetResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveSnippetResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'RetrieveSnippetResponse',
            ['errors' => $this->errors, 'snippet' => $this->snippet]
        );
    }
