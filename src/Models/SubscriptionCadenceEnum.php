...
/**
 * Determines the billing cadence of a [Subscription](https://developer.squareup.
 * com/reference/square_2021-08-18/objects/Subscription)
 */
class SubscriptionCadenceEnum
{
    /**
     * Once per day
     */
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for SubscriptionCadenceEnum.");
    }
}
