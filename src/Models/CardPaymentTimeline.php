...
class CardPaymentTimeline implements \JsonSerializable
{
    ...
    /**
     * Converts the CardPaymentTimeline object to a human-readable string representation.
     *
     * @return string The string representation of the CardPaymentTimeline object.
     */
