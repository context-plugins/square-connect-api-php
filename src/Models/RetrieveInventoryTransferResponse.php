...
class RetrieveInventoryTransferResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveInventoryTransferResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveInventoryTransferResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'RetrieveInventoryTransferResponse',
            ['errors' => $this->errors, 'transfer' => $this->transfer]
        );
    }
