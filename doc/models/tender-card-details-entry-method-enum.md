...
# Tender Card Details Entry Method Enum

Indicates the method used to enter the card's details.

## Enumeration

`TenderCardDetailsEntryMethodEnum`
...
```php
use SquareConnectAPILib\Models\TenderCardDetailsEntryMethodEnum;

$tenderCardDetailsEntryMethod = TenderCardDetailsEntryMethodEnum::KEYED;
```
