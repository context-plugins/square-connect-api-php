...
class SearchOrdersFilter implements \JsonSerializable
{
     ...
     * [FulfillmentRecipient](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/OrderFulfillmentRecipient) `customer_id`.
     */
    ...
    /**
     * Converts the SearchOrdersFilter object to a human-readable string representation.
     *
     * @return string The string representation of the SearchOrdersFilter object.
     */
