...
class RetrieveWageSettingResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveWageSettingResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveWageSettingResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'RetrieveWageSettingResponse',
            ['errors' => $this->errors, 'wageSetting' => $this->wageSetting]
        );
    }
