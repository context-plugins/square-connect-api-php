...
class RetrieveDisputeResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveDisputeResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveDisputeResponse object.
     */
