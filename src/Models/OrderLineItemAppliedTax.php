...
class OrderLineItemAppliedTax implements \JsonSerializable
{
    ...
    /**
     * Converts the OrderLineItemAppliedTax object to a human-readable string representation.
     *
     * @return string The string representation of the OrderLineItemAppliedTax object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'OrderLineItemAppliedTax',
            ['appliedMoney' => $this->appliedMoney, 'taxUid' => $this->taxUid, 'uid' => $this->uid]
        );
    }
