...
class V1ListRefundsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V1ListRefundsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1ListRefundsRequest object.
     */
