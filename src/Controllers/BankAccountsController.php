...
{
    /**
     * Returns a list of [BankAccount](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/BankAccount) objects linked to a Square account.
     *
     ...
     *
     * @return ListBankAccountsResponse Response from the API call
     *
    ...
    public function listBankAccounts(
        ...
        $_resHandler = $this->responseHandler()->type(ListBankAccountsResponse::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * Returns details of a [BankAccount](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/BankAccount) identified by V1 bank account ID.
     *
     ...
     *
     * @return GetBankAccountByV1IdResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getBankAccountByV1Id(string $v1BankAccountId): GetBankAccountByV1IdResponse
    {
        ...
        $_resHandler = $this->responseHandler()->type(GetBankAccountByV1IdResponse::class);
    ...
    /**
     * Returns details of a [BankAccount](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/BankAccount)
     * linked to a Square account.
     *
     * @param string $bankAccountId Square-issued ID of the desired `BankAccount`.
     *
     * @return GetBankAccountResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getBankAccount(string $bankAccountId): GetBankAccountResponse
    {
        ...
        $_resHandler = $this->responseHandler()->type(GetBankAccountResponse::class);
