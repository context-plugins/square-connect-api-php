...
class UpsertCatalogObjectResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the UpsertCatalogObjectResponse object to a human-readable string representation.
     *
     * @return string The string representation of the UpsertCatalogObjectResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'UpsertCatalogObjectResponse',
            ['catalogObject' => $this->catalogObject, 'errors' => $this->errors, 'idMappings' => $this->idMappings]
        );
    }
