...
# Order Line Item Discount Type Enum

Indicates how the discount is applied to the associated line item or order.

## Enumeration

`OrderLineItemDiscountTypeEnum`
...
```php
use SquareConnectAPILib\Models\OrderLineItemDiscountTypeEnum;

$orderLineItemDiscountType = OrderLineItemDiscountTypeEnum::FIXED_PERCENTAGE;
```
