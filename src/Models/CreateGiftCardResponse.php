...
class CreateGiftCardResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateGiftCardResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreateGiftCardResponse object.
     */
