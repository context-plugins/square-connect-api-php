...
class CatalogQuerySortedAttribute implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogQuerySortedAttribute object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogQuerySortedAttribute object.
     */
