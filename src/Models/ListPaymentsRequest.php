 ...
 * [ListPayments](https://developer.squareup.com/reference/square_2021-08-18/payments-api/list-
 * payments).
 *
...
class ListPaymentsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ListPaymentsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ListPaymentsRequest object.
     */
