...
class TerminalCheckoutQuery implements \JsonSerializable
{
    ...
    /**
     * Converts the TerminalCheckoutQuery object to a human-readable string representation.
     *
     * @return string The string representation of the TerminalCheckoutQuery object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('TerminalCheckoutQuery', ['filter' => $this->filter, 'sort' => $this->sort]);
    }
