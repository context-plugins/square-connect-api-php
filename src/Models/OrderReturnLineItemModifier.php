...
class OrderReturnLineItemModifier implements \JsonSerializable
{
    ...
    /**
     * Converts the OrderReturnLineItemModifier object to a human-readable string representation.
     *
     * @return string The string representation of the OrderReturnLineItemModifier object.
     */
