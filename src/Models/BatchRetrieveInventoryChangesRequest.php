...
class BatchRetrieveInventoryChangesRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the BatchRetrieveInventoryChangesRequest object to a human-readable string representation.
     *
     * @return string The string representation of the BatchRetrieveInventoryChangesRequest object.
     */
