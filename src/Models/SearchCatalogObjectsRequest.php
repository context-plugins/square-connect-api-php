...
class SearchCatalogObjectsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the SearchCatalogObjectsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the SearchCatalogObjectsRequest object.
     */
