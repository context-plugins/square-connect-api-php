...
class RetrieveDisputeEvidenceResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveDisputeEvidenceResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveDisputeEvidenceResponse object.
     */
