...
class Invoice implements \JsonSerializable
{
     ...
     * which the invoice is created.
     * This field is required when creating an invoice, and the order must be in the `OPEN` state.
     *
     * To view the line items and other information for the associated order, call the
     * [RetrieveOrder](https://developer.squareup.com/reference/square_2021-08-18/orders-api/retrieve-
     * order) endpoint using the order ID.
     */
     ...
     * The ID of the [subscription](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/Subscription) associated with the invoice.
