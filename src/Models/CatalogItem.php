...
class CatalogItem implements \JsonSerializable
{
     ...
     *
     * Only items of product type `REGULAR` or `APPOINTMENTS_SERVICE` may be created by this API; items
     * with other product
     * types are read-only.
     */
    ...
    /**
     * Returns Variations.
     * A list of [CatalogItemVariation](https://developer.squareup.com/reference/square_2021-08-
     * 18/objects/CatalogItemVariation) objects for this item. An item must have
    ...
    /**
     * Converts the CatalogItem object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogItem object.
     */
