...
class CatalogProductSet implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogProductSet object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogProductSet object.
     */
