...
class RetrieveGiftCardFromNonceResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveGiftCardFromNonceResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveGiftCardFromNonceResponse object.
     */
