...
class RetrieveCustomerSegmentResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RetrieveCustomerSegmentResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RetrieveCustomerSegmentResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'RetrieveCustomerSegmentResponse',
            ['errors' => $this->errors, 'segment' => $this->segment]
        );
    }
