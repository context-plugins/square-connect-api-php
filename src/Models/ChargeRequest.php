 ...
 * a request to the [Charge](https://developer.squareup.com/reference/square_2021-08-18/transactions-
 * api/charge) endpoint.
 *
 * Deprecated - recommend using [CreatePayment](https://developer.squareup.com/reference/square_2021-08-
 * 18/payments-api/create-payment)
 */
class ChargeRequest implements \JsonSerializable
{
     ...
     */
    public function __construct(Money $amountMoney, string $idempotencyKey)
    {
     ...
     * [CaptureTransaction](https://developer.squareup.com/reference/square_2021-08-18/transactions-
     * api/capture-transaction) endpoint) or a Void
     * (with the [VoidTransaction](https://developer.squareup.com/reference/square_2021-08-18/transactions-
     * api/void-transaction) endpoint).
     *
     * Default value: `false`
     */
    ...
    /**
     * Converts the ChargeRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ChargeRequest object.
     */
