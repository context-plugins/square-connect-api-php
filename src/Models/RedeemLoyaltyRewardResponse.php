...
class RedeemLoyaltyRewardResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the RedeemLoyaltyRewardResponse object to a human-readable string representation.
     *
     * @return string The string representation of the RedeemLoyaltyRewardResponse object.
     */
