...
class BatchRetrieveInventoryChangesResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the BatchRetrieveInventoryChangesResponse object to a human-readable string representation.
     *
     * @return string The string representation of the BatchRetrieveInventoryChangesResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'BatchRetrieveInventoryChangesResponse',
            ['changes' => $this->changes, 'cursor' => $this->cursor, 'errors' => $this->errors]
        );
    }
