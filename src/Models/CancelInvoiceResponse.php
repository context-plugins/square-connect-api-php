...
class CancelInvoiceResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CancelInvoiceResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CancelInvoiceResponse object.
     */
