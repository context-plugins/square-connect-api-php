...
class BatchRetrieveInventoryCountsResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the BatchRetrieveInventoryCountsResponse object to a human-readable string representation.
     *
     * @return string The string representation of the BatchRetrieveInventoryCountsResponse object.
     */
