...
# Location Capability Enum

The capabilities a location may have.

## Enumeration

`LocationCapabilityEnum`
...
```php
use SquareConnectAPILib\Models\LocationCapabilityEnum;

$locationCapability = LocationCapabilityEnum::CREDIT_CARD_PROCESSING;
```
