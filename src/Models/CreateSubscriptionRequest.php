 ...
 * [CreateSubscription](https://developer.squareup.com/reference/square_2021-08-18/subscriptions-
 * api/create-subscription) endpoint request.
 */
class CreateSubscriptionRequest implements \JsonSerializable
{
     ...
     * @param string $planId
     */
    public function __construct(string $customerId, string $locationId, string $planId)
    {
     ...
     * 18/objects/Customer) [card](https://developer.squareup.com/reference/square_2021-08-18/objects/Card)
     * to charge.
