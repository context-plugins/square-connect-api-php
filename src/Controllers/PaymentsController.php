...
use SquareConnectAPILib\Models\CompletePaymentResponse;
use SquareConnectAPILib\Models\CreatePaymentRequest;
use SquareConnectAPILib\Models\CreatePaymentResponse;
use SquareConnectAPILib\Models\GetPaymentResponse;
use SquareConnectAPILib\Models\ListPaymentsResponse;
use SquareConnectAPILib\Models\UpdatePaymentRequest;
use SquareConnectAPILib\Models\UpdatePaymentResponse;
...
class PaymentsController extends BaseController
{
     ...
     *        Default: `100`
     *
     * @return ListPaymentsResponse Response from the API call
     *
    ...
    public function listPayments(
        ...
        $_resHandler = $this->responseHandler()->type(ListPaymentsResponse::class);
     ...
     *
     * @return CreatePaymentResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function createPayment(CreatePaymentRequest $body): CreatePaymentResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/payments')
            ->auth('oauth2')
            ->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));

        $_resHandler = $this->responseHandler()->type(CreatePaymentResponse::class);
     ...
     *        See the corresponding object definition for field details.
     *
     * @return CancelPaymentByIdempotencyKeyResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function cancelPaymentByIdempotencyKey(
        ...
        $_resHandler = $this->responseHandler()->type(CancelPaymentByIdempotencyKeyResponse::class);
     ...
     *
     * @return GetPaymentResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function getPayment(string $paymentId): GetPaymentResponse
    {
        ...
        $_resHandler = $this->responseHandler()->type(GetPaymentResponse::class);
     ...
     *        See the corresponding object definition for field details.
     *
     * @return UpdatePaymentResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function updatePayment(string $paymentId, UpdatePaymentRequest $body): UpdatePaymentResponse
    {
        ...
        $_resHandler = $this->responseHandler()->type(UpdatePaymentResponse::class);
    ...
    public function cancelPayment(string $paymentId): CancelPaymentResponse
    {
        ...
        $_resHandler = $this->responseHandler()->type(CancelPaymentResponse::class);
     ...
     *
     * @return CompletePaymentResponse Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function completePayment(string $paymentId): CompletePaymentResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/payments/{payment_id}/complete')
            ->auth('oauth2')
            ->parameters(TemplateParam::init('payment_id', $paymentId));

        $_resHandler = $this->responseHandler()->type(CompletePaymentResponse::class);
