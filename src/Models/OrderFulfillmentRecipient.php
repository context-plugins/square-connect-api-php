...
class OrderFulfillmentRecipient implements \JsonSerializable
{
    ...
    /**
     * Converts the OrderFulfillmentRecipient object to a human-readable string representation.
     *
     * @return string The string representation of the OrderFulfillmentRecipient object.
     */
