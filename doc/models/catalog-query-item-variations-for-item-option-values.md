...
$catalogQueryItemVariationsForItemOptionValues = CatalogQueryItemVariationsForItemOptionValuesBuilder::init()
    ->itemOptionValueIds(
        [
            'item_option_value_ids4',
            'item_option_value_ids5',
            'item_option_value_ids6'
        ]
    )
    ->build();
```
