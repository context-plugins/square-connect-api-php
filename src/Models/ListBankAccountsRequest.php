...
class ListBankAccountsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ListBankAccountsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ListBankAccountsRequest object.
     */
