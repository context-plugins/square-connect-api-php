...
```php
use SquareConnectAPILib\Models\Builders\GiftCardActivityImportReversalBuilder;
use SquareConnectAPILib\Models\Builders\MoneyBuilder;

$giftCardActivityImportReversal = GiftCardActivityImportReversalBuilder::init(
    MoneyBuilder::init()
        ->amount(186)
        ->currency('currency8')
        ->build()
