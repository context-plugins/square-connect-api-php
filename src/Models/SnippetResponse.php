...
class SnippetResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the SnippetResponse object to a human-readable string representation.
     *
     * @return string The string representation of the SnippetResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('SnippetResponse', ['errors' => $this->errors, 'snippet' => $this->snippet]);
    }
