...
class ObtainTokenRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ObtainTokenRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ObtainTokenRequest object.
     */
