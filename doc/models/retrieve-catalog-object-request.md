...
```php
use SquareConnectAPILib\Models\Builders\RetrieveCatalogObjectRequestBuilder;

$retrieveCatalogObjectRequest = RetrieveCatalogObjectRequestBuilder::init()
    ->catalogVersion(196)
