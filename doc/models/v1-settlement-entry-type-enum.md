...
# V1 Settlement Entry Type Enum

## Enumeration

`V1SettlementEntryTypeEnum`
...
```php
use SquareConnectAPILib\Models\V1SettlementEntryTypeEnum;

$v1SettlementEntryType = V1SettlementEntryTypeEnum::FREE_PROCESSING;
```
