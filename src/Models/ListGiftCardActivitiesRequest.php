...
class ListGiftCardActivitiesRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ListGiftCardActivitiesRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ListGiftCardActivitiesRequest object.
     */
