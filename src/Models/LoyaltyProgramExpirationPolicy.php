...
class LoyaltyProgramExpirationPolicy implements \JsonSerializable
{
    ...
    /**
     * Converts the LoyaltyProgramExpirationPolicy object to a human-readable string representation.
     *
     * @return string The string representation of the LoyaltyProgramExpirationPolicy object.
     */
