...
# Order Service Charge Calculation Phase Enum
...
`OrderServiceChargeCalculationPhaseEnum`
...
```php
use SquareConnectAPILib\Models\OrderServiceChargeCalculationPhaseEnum;

$orderServiceChargeCalculationPhase = OrderServiceChargeCalculationPhaseEnum::SUBTOTAL_PHASE;
```
