...
class V1TransactionsController extends BaseController
{
    /**
     ...
     *
     * @return V1Order[] Response from the API call
     *
    ...
    public function listOrders(
        ...
        $_resHandler = $this->responseHandler()->type(V1Order::class, 1);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveOrder(string $locationId, string $orderId): V1Order
    {
        ...
        $_resHandler = $this->responseHandler()->type(V1Order::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function updateOrder(string $locationId, string $orderId, V1UpdateOrderRequest $body): V1Order
    {
     ...
     *
     * @return V1Payment[] Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function listPayments(
        ...
        $_resHandler = $this->responseHandler()->type(V1Payment::class, 1);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrievePayment(string $locationId, string $paymentId): V1Payment
    {
        ...
        $_resHandler = $this->responseHandler()->type(V1Payment::class);
     ...
     *        original query to the endpoint.
     *
     * @return V1Refund[] Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function listRefunds(
        ...
        $_resHandler = $this->responseHandler()->type(V1Refund::class, 1);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function createRefund(string $locationId, V1CreateRefundRequest $body): V1Refund
    {
        ...
        $_resHandler = $this->responseHandler()->type(V1Refund::class);
     ...
     *        original query to the endpoint.
     *
     * @return V1Settlement[] Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function listSettlements(
        ...
        $_resHandler = $this->responseHandler()->type(V1Settlement::class, 1);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function retrieveSettlement(string $locationId, string $settlementId): V1Settlement
    {
        ...
        $_resHandler = $this->responseHandler()->type(V1Settlement::class);
