...
class DeprecatedCreateDisputeEvidenceTextRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the DeprecatedCreateDisputeEvidenceTextRequest object to a human-readable string
     * representation.
     *
     * @return string The string representation of the DeprecatedCreateDisputeEvidenceTextRequest object.
     */
