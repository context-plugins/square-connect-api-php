 ...
 * [ListPaymentRefunds](https://developer.squareup.com/reference/square_2021-08-18/refunds-api/list-
 * payment-refunds).
 *
...
class ListPaymentRefundsRequest implements \JsonSerializable
{
     ...
     * For a list of refund status values, see [PaymentRefund](https://developer.squareup.
    ...
    /**
     * Converts the ListPaymentRefundsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ListPaymentRefundsRequest object.
     */
