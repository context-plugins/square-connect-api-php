 ...
 */
class CatalogCustomAttributeDefinitionAppVisibilityEnum
{
    /**
    ...
    private const _ALL_VALUES =
        [self::APP_VISIBILITY_HIDDEN, self::APP_VISIBILITY_READ_ONLY, self::APP_VISIBILITY_READ_WRITE_VALUES];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for CatalogCustomAttributeDefinitionAppVisibilityEnum.");
    }
}
