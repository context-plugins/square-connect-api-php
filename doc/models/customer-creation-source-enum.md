...
# Customer Creation Source Enum

Indicates the method used to create the customer profile.

## Enumeration

`CustomerCreationSourceEnum`
...
```php
use SquareConnectAPILib\Models\CustomerCreationSourceEnum;

$customerCreationSource = CustomerCreationSourceEnum::UNMERGE_RECOVERY;
```
