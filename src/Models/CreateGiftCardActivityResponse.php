...
class CreateGiftCardActivityResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateGiftCardActivityResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CreateGiftCardActivityResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CreateGiftCardActivityResponse',
            ['errors' => $this->errors, 'giftCardActivity' => $this->giftCardActivity]
        );
    }
