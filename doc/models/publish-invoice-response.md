...
```php
use SquareConnectAPILib\Models\Builders\PublishInvoiceResponseBuilder;
...
$publishInvoiceResponse = PublishInvoiceResponseBuilder::init()
    ->errors(
        [
            ErrorBuilder::init(
                'category8',
    ...
    ->invoice(
        InvoiceBuilder::init()
            ...
            ->publicUrl('https://squareup.com/pay-invoice/inv:0-ChCHu2mZEabLeeHahQnXDjZQECY')
