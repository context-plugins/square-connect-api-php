...
$catalogInfoResponseLimits = CatalogInfoResponseLimitsBuilder::init()
    ->batchDeleteMaxObjectIds(90)
    ->batchRetrieveMaxObjectIds(104)
    ->batchUpsertMaxObjectsPerBatch(0)
    ->batchUpsertMaxTotalObjects(84)
    ->searchMaxPageLimit(194)
    ->build();
```
