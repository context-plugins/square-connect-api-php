...
class BusinessAppointmentSettings implements \JsonSerializable
{
    ...
    /**
     * Converts the BusinessAppointmentSettings object to a human-readable string representation.
     *
     * @return string The string representation of the BusinessAppointmentSettings object.
     */
