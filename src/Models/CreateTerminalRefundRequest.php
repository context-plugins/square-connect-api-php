...
class CreateTerminalRefundRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CreateTerminalRefundRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CreateTerminalRefundRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'CreateTerminalRefundRequest',
            ['idempotencyKey' => $this->idempotencyKey, 'refund' => $this->refund]
        );
    }
