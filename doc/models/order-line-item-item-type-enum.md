...
# Order Line Item Item Type Enum

Represents the line item type.

## Enumeration

`OrderLineItemItemTypeEnum`
...
```php
use SquareConnectAPILib\Models\OrderLineItemItemTypeEnum;

$orderLineItemItemType = OrderLineItemItemTypeEnum::GIFT_CARD;
```
