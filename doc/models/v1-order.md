...
| `state` | `?string` | Optional | Whether the tax is an ADDITIVE tax or an INCLUSIVE tax. | getState(): ?string | setState(?string state): void |
...
$v1Order = V1OrderBuilder::init()
    ->btcPriceSatoshi(39.72)
    ->btcReceiveAddress('btc_receive_address6')
