...
class CatalogInfoResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the CatalogInfoResponse object to a human-readable string representation.
     *
     * @return string The string representation of the CatalogInfoResponse object.
     */
